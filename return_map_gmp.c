...
/* It was used to verify that rot(f_q,r) is algebraic of degree at most
2 when 0 < q,r < 1 are rationals such that the denominator of q is at most
30 and the denominator of r is at most 1000.  See the paper
...
int main()
{
  ...
  for(Q.n=3L;Q.n<=30L;Q.n++) /* This look specifies the range for q. */
